...
function agregarCompra($conn, $producto, $cantidad, $precio) {
    // Agrega la lógica para insertar la compra en la base de datos
    // ...
    return true; // Devuelve true por ahora, ajusta según sea necesario
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (agregarCompra($conn, $producto, $cantidad, $precio)) {
...
body {
        ...
        .navbar {
            background-color: #0066cc; /* Color de fondo de la barra */
            color: white;
            padding: 10px 20px;
            display: flex;
            align-items: center;
        ...
        .navbar img {
            width: 50px; /* Ajusta el tamaño del logo según necesidades */
            height: auto;
            margin-right: 15px;
        }
        .navbar h1 {
        ...
        header {
            padding: 20px;
            text-align: center;
            background-color: #333; /* Mantener este color o cambiarlo si se desea */
            color: white;
        }
        table {
            margin: 20px auto;
    ...
    border-collapse: collapse;
    width: 80%;
    box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); /* Sombra para efecto elevado */
}

th, td {
    padding: 12px;
    border: 1px solid #ddd;
    text-align: center; /* Centrado para hacerlo más legible */
}
...
h1 {
    color: #333;
    margin-top: 50px; /* Espaciado adicional antes de las secciones */
}
.table-wrapper {
    display: flex;
...
.table-container {
    width: 45%; /* Ajusta esto según el ancho deseado para cada tabla */
    margin: 0 2%; /* Espaciado entre las tablas */
